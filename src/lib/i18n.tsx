...
const dict = {
  ...
  batchTimeLabel: { zh: "每天的上下班时间", en: "Daily start/end time" },
  ...
  recapHoursCaption: { zh: "跨 {n} 个雇主的工时总和", en: "Total hours across {n} employer(s)" },
  recapPayEyebrow: { zh: "赚到手的有", en: "You earned" },
  recapPayCaption: { zh: "「{name}」是本月主力雇主", en: "\"{name}\" was your top employer this month" },
