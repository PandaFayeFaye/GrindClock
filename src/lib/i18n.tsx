...
const dict = {
  ...
  coachIncomeBody: { zh: "左边卡片可切换今日/本周，右边固定显示本月，加班时长和收入也会一起显示出来。", en: "The left card toggles today/week; the right card always shows this month. Overtime hours and pay show up here too." },
