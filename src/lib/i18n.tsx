...
const dict = {
  ...
  backfill: { zh: "补录搬砖时长", en: "Backfill hours" },
  addEmployer: { zh: "添加打工副本", en: "Add gig" },
  ...
  groupArchivedEmployers: { zh: "已停用的副本", en: "Retired gigs" },
  groupTeam: { zh: "团队", en: "Team" },
  teamNav: { zh: "团队代记搬砖时长（组长模式）", en: "Team time logging (lead mode)" },
  ...
  dailyRecapSub: {
    zh: "下班后30-60分钟推送今日战绩",
    en: "Push a summary 30-60min after you clock out",
  },
  ...
  languageSub: { zh: "切换应用显示语言", en: "Switch the app's display language" },
  pushTodo: {
    zh: "每日小结推送即将上线，敬请期待～上面的开关目前会记住你的偏好，功能上线后自动生效。",
    en: "Daily recap push is coming soon -- the toggle above remembers your preference and will take effect once it launches.",
  },
  ...
  syncStatus: {
    zh: "云同步状态：已连接（数据实时同步，登录同一账号即可在其他设备看到）",
    en: "Cloud sync: Connected (data syncs live -- sign in with the same account on another device to see it there)",
  },
  ...
  moodSlack: { zh: "摸鱼", en: "Slacking" },
  moodGrind: { zh: "爆肝", en: "Grinding" },
  moodOx: { zh: "社畜", en: "Burnt out" },
  moodFlat: { zh: "躺平", en: "Checked out" },
  thisShift: { zh: "本次搬砖时长", en: "this shift" },
  ...
  batchBackfillTitle: { zh: "批量补录搬砖时长", en: "Batch backfill hours" },
  ...
  animalRat: { zh: "老鼠", en: "Rat" },
  animalCat: { zh: "猫咪", en: "Cat" },
  animalCow: { zh: "小牛", en: "Cow" },
  animalRabbit: { zh: "兔子", en: "Rabbit" },
  animalTiger: { zh: "老虎", en: "Tiger" },
  animalSheep: { zh: "小羊", en: "Sheep" },
  animalMonkey: { zh: "猴子", en: "Monkey" },
  animalDog: { zh: "狗狗", en: "Dog" },
  animalPig: { zh: "猪猪", en: "Pig" },
  animalHorse: { zh: "小马", en: "Horse" },
  animalSnake: { zh: "小蛇", en: "Snake" },
  animalChick: { zh: "小鸡", en: "Chick" },
  animalDragon: { zh: "小龙", en: "Dragon" },
  animalGiraffe: { zh: "长颈鹿", en: "Giraffe" },
  animalCapybara: { zh: "卡皮巴拉", en: "Capybara" },
  currencyCNY: { zh: "人民币", en: "Chinese Yuan" },
  currencyUSD: { zh: "美元", en: "US Dollar" },
  currencyEUR: { zh: "欧元", en: "Euro" },
  currencyGBP: { zh: "英镑", en: "British Pound" },
  currencyAUD: { zh: "澳元", en: "Australian Dollar" },
  currencyCAD: { zh: "加元", en: "Canadian Dollar" },
  currencyJPY: { zh: "日元", en: "Japanese Yen" },
  currencyKRW: { zh: "韩元", en: "Korean Won" },
  currencyHKD: { zh: "港币", en: "Hong Kong Dollar" },
  currencySGD: { zh: "新加坡元", en: "Singapore Dollar" },
  ...
  excessHoursLabel: { zh: "额外超出时长（加班）", en: "Extra time beyond schedule (OT)" },
  overtimeRuleLabel: { zh: "加班计算规则", en: "Overtime pay rule" },
  hoursUnitPlain: { zh: "小时", en: "h" },
  ...
  backfillTitle: { zh: "补录搬砖时长", en: "Backfill hours" },
  editEntryTitle: { zh: "编辑搬砖记录", en: "Edit entry" },
  logForTitle: { zh: "为{name}记搬砖时长", en: "Log for {name}" },
  save: { zh: "保存", en: "Save" },
  ...
  durationLabel: { zh: "搬砖时长", en: "Duration" },
  ...
  dangerZoneLabel: { zh: "副本管理", en: "Gig management" },
  archiveEmployerHint: { zh: "停用后，首页将不再显示这份副本，以后也不会再往它身上记新的工时——但历史打卡记录都会保留，随时可以查看，也可以重新启用它。", en: "Once retired, this gig disappears from Home and can't be logged against anymore -- but every past entry stays intact and viewable, and you can reactivate it anytime." },
  archiveEmployerBtn: { zh: "停用这份打工副本", en: "Retire this gig" },
  archiveEmployerConfirmBtn: { zh: "再点一次，确认停用", en: "Tap again to confirm" },
  archivingEllipsis: { zh: "停用中...", en: "Retiring..." },
  reactivateEmployerHint: { zh: "这份副本目前已停用，不会出现在首页。重新启用后就能继续打卡记录了。", en: "This gig is currently retired and hidden from Home. Reactivate it to start logging hours again." },
  reactivateEmployerBtn: { zh: "重新启用这份打工副本", en: "Reactivate this gig" },
  reactivatingEllipsis: { zh: "启用中...", en: "Reactivating..." },
  ...
  // ---- Login screen ----
  appTagline: { zh: "多副本搬砖时长与收入记录", en: "Track hours and pay across every gig" },
  ...
  authErrProviderDisabled: {
    zh: "邮箱登录暂时不可用，请稍后再试或改用手机号登录",
    en: "Email sign-in is temporarily unavailable -- please try again later or use phone sign-in instead",
  },
  ...
  onboard1Body: {
    zh: "送外卖、跑网约车、发传单、代课……不管同时打几份工，这里都能一起记搬砖时长、算收入，不用来回切几个应用。",
  ...
  onboard2Body: {
    zh: "填一下副本名字（BOSS大大是谁）、结算方式（时薪/日结/按单……），马上就能开始打卡记搬砖时长了。",
  ...
  aiDisclaimer: {
    zh: "目前识别还比较基础，只能抓一些「6小时」「XX店」这样的简单信息，看不懂太复杂的句子——保存前一定要检查一下下面的字段对不对。",
    en: "Recognition is still fairly basic and can only pick up simple things like \"6 hours\" or a shop name -- it can't parse complex sentences yet. Please double-check the fields below before saving.",
  },
  ...
  recapHoursCaption: { zh: "跨 {n} 个副本的搬砖时长总和", en: "Total hours across {n} gig(s)" },
  ...
  notEnoughDataYet: { zh: "还没有搬砖记录，先去打个卡吧", en: "No hours logged yet -- go clock in first" },
  ...
  companionSlack: { zh: "摸鱼一下也没关系，别忘了适当放松", en: "A little slacking is fine -- remember to actually relax" },
  companionGrind: { zh: "爆肝冲业绩呢？记得肝完记得歇一歇", en: "Grinding hard, huh? Rest up once you're done" },
  companionOx: { zh: "有点累趴了，社畜也需要被好好照顾", en: "Feeling burnt out -- even grinders need looking after" },
  companionFlat: { zh: "躺平一天也不丢人，慢慢来", en: "Checking out for a day is totally fine -- take it slow" },

  // ---- Team roster ----
  teamTitle: { zh: "团队", en: "Team" },
  leadModePill: { zh: "组长模式", en: "Lead mode" },
  teamIsolationNote: {
    zh: "这里记录的搬砖时长归属于被代记录人，和你自己的个人打工记录完全分开统计，不会混进你的首页数据",
  ...
  teamWeekHoursLabel: { zh: "团队本周总搬砖时长", en: "Team hours this week" },
  ...
  workerIsolationInfo: {
    zh: "这个人的搬砖记录会完全独立统计，不会出现在你自己的首页/统计页数据里",
  ...
  cumulativeHours: { zh: "累计总搬砖时长", en: "Total hours" },
  ...
  recapOvertimeTileLabel: { zh: "加班时长 · 加班收入", en: "Overtime hours · pay" },
  ...
  coachTierBody: { zh: "根据累计搬砖时长晋级称号，点这里能看到完整的成就墙和进阶路线。", en: "Your title levels up with cumulative hours -- tap to see the full badge wall and progression path." },
  coachIncomeTitle: { zh: "今日 / 本周收入", en: "Today / week income" },
  coachIncomeBody: { zh: "点击这里可以切换看今日还是本周赚了多少，超出排班的加班时长和收入也会一起显示。", en: "Tap to switch between today and this week -- overtime hours and pay show up here too when they apply." },
  coachIncomeMonthTitle: { zh: "本月已赚", en: "Earned this month" },
  coachIncomeMonthBody: { zh: "这张卡片固定统计本月至今的总工时和总收入，跨所有副本汇总，同样会算上加班收入。", en: "This card always totals this month's hours and pay across every gig, overtime included." },
  ...
  coachRowDetailTitle: { zh: "每个副本的当日战绩", en: "Each gig's daily recap" },
  coachRowDetailBody: { zh: "今天打过卡的副本下面会显示当天的工时、收入，超出排班的部分会标为加班。", en: "Any gig you've clocked for today shows its hours and pay right here, with overtime flagged separately." },
  ...
  coachCompanionSecretTitle: { zh: "多摸摸它……", en: "Pet it a little more..." },
  coachCompanionSecretBody: {
    zh: "认真喂养它之外，好像还藏着点别的小秘密，多点几下试试看？",
    en: "Feeding it right is one thing -- but it might be hiding something else. Try tapping it a few more times.",
  },
  coachFabTitle: { zh: "AI记工 / 补录 / 开副本", en: "AI capture / backfill / add gig" },
  coachFabBody: { zh: "点这个加号可以拍照/语音记工、批量补录搬砖时长、或者开启新副本。", en: "Tap this + to capture by photo/voice, backfill hours in bulk, or add a new gig." },
  coachStatsTitle: { zh: "统计页：趋势 / 日历 / 排行", en: "Stats: trends, calendar, leaderboard" },
  coachStatsBody: { zh: "这里能看每天的工时收入趋势、月度日历、副本排行榜，加班也有专门的统计模块，底部还有完整明细，页面上方有「查看明细」按钮直接跳过去。", en: "See daily hours/pay trends, a monthly calendar, and a gig leaderboard here, plus a dedicated overtime summary and the full detail list -- use the \"View details\" button up top to jump straight there." },
  coachSettingsTitle: { zh: "我的：心情记录 & 数据洞察", en: "Me: mood log & insights" },
  coachSettingsBody: { zh: "这里能记录每天的心情曲线、查看净收益对比和本月战绩总结，还能管理成就徽章墙。", en: "Log your daily mood curve, compare net pay across gigs, review your monthly recap, and check your badge wall." },
  ...
  heatLegendMore: { zh: "多", en: "More" },
  exportDetailFilenamePart: { zh: "明细", en: "detail" },
  ...
  leaderboardEmpty: { zh: "这周还没有搬砖记录", en: "No hours logged this week yet" },
  ...
  companionBubbleCrash: { zh: "崩溃中...", en: "crashing out..." },
  companionBubbleNormal: { zh: "搬砖中", en: "grinding along" },
  companionBubbleGreat: { zh: "太爽了!", en: "feeling great!" },
  companionBubbleHeartbeat: { zh: "心动ing~", en: "heart racing~" },
  companionBubbleSlack: { zh: "摸鱼中~", en: "slacking off~" },
  companionBubbleGrind: { zh: "爆肝冲鸭!", en: "grinding hard!" },
  companionBubbleOx: { zh: "好社畜...", en: "so burnt out..." },
  companionBubbleFlat: { zh: "躺平中 ZZZ...", en: "lying flat ZZZ..." },
  ...
  townUnlockPrompt: { zh: "开启摸鱼小镇？", en: "Unlock Slackerville?" },
  townUnlockBody: {
    zh: "这是一个隐藏的小玩法：送搭子去打工、攒特产、升职、还能去世界里跟朋友互相偷菜～不会影响你的真实等级。",
    en: "A hidden side game: send your buddy to work, hoard loot, get promoted, and steal from friends in the World -- none of it touches your real tier.",
  },
  townUnlockConfirm: { zh: "开启", en: "Unlock it" },
  townUnlockCancel: { zh: "还是算了", en: "Not now" },
  townEntryLabel: { zh: "摸鱼小镇", en: "Slackerville" },

  townTitle: { zh: "摸鱼小镇", en: "Slackerville" },
  townOxFeed: { zh: "牛马粮 {n}", en: "Grind Fuel: {n}" },
  townExp: { zh: "摸鱼资历 {n}", en: "Grind Cred: {n}" },
  townRation: { zh: "今日已领取配给", en: "Today's ration claimed" },
  townRationClaimed: { zh: "领到 {n} 牛马粮！", en: "Claimed {n} Grind Fuel!" },
  townClaimRationBtn: { zh: "领取每日配给", en: "Claim daily ration" },
  townWorldNav: { zh: "去世界看看", en: "Go to the World" },
  townInventoryTitle: { zh: "仓库", en: "Stash" },
  ...
  townSpriteHint: { zh: "点我看看～", en: "Tap me!" },
  townFeedButton: { zh: "喂它吃点东西（花{n}牛马粮）", en: "Feed it a snack (costs {n} Grind Fuel)" },
  townFeedSuccess: { zh: "喂饱啦～", en: "Fed and happy!" },
  townFeedFailInsufficient: { zh: "牛马粮不够了", en: "Not enough Grind Fuel" },
  townFeedFailGeneric: { zh: "喂食失败", en: "Couldn't feed it" },
  townCancelButton: { zh: "召回搭子", en: "Call it back early" },
  townCancelConfirmTitle: { zh: "召回搭子？", en: "Call it back early?" },
  townCancelConfirmBody: {
    zh: "已经花掉的班车费不会退还，且这一趟不会有任何产出，确定要提前召回吗？",
    en: "The Grind Fuel you already spent won't be refunded, and this shift won't pay out at all -- call it back anyway?",
  },
  townCancelConfirmBtn: { zh: "召回", en: "Call it back" },
  townCancelSuccess: { zh: "搭子回来了", en: "It's back" },
  townCancelFailGeneric: { zh: "召回失败", en: "Couldn't call it back" },
  townNoticeStolen: { zh: "{name} 偷了你一点特产", en: "{name} stole a little something from your stash" },
  townNoticeSkimmed: { zh: "{name} 给你画了个饼，把你派去打工了", en: "{name} pulled rank and pushed a shift onto you" },
  townNoticeCriticized: { zh: "{name} 发现你没打卡，批评了你", en: "{name} called you out for not checking in" },
  townCriticizeBtn: { zh: "批评TA", en: "Call them out" },
  townCriticizeSuccess: { zh: "已经批评TA啦", en: "Called them out" },
  townCriticizeFailCheckedIn: { zh: "TA已经打卡了，冤枉TA了", en: "They already checked in -- false alarm" },
  townCriticizeFailCooldown: { zh: "已经批评过了，再等等", en: "Already called them out -- give it a rest" },
  townCriticizeFailGeneric: { zh: "批评失败", en: "Couldn't call them out" },
  ...
  townJobStartFailInsufficient: { zh: "牛马粮不够了", en: "Not enough Grind Fuel" },
  ...
  townWorldTitle: { zh: "摸鱼小镇 · 世界", en: "Slackerville · World" },
  townWorldHint: { zh: "所有开启了摸鱼小镇的搭子都在这里，互相可见互相可逛～", en: "Everyone who's unlocked Slackerville hangs out here." },
  ...
  townWorldSkim: { zh: "画饼摊派", en: "Pass the Buck" },
