...
const dict = {
  ...
  payCalendarTitle: { zh: "本月活跃度日历（颜色越深赚得越多）", en: "This month's activity (darker = more earned)" },
  streakCalendarTitle: { zh: "连续打卡日历（有没有打卡，不看赚多少）", en: "Streak calendar (punched or not, not how much)" },
