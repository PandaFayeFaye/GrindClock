...
const dict = {
  ...
  overtimeMultiplierNote: { zh: "按 {mult}x 加班工资计算（可在雇主设置里修改倍数）", en: "Paid at {mult}x (change the multiplier in employer settings)" },
  overtimeFixedRateNote: { zh: "按固定加班时薪 {sym}{rate}/小时计算（可在雇主设置里修改）", en: "Paid at a flat {sym}{rate}/h (change it in employer settings)" },
