...
const dict = {
  ...
  dangerZoneLabel: { zh: "危险操作", en: "Danger zone" },
  deleteEmployerHint: { zh: "删除后，这份副本和它名下的所有打卡记录都会被永久删除，无法恢复。", en: "Deleting this gig permanently removes it and every entry logged against it -- this can't be undone." },
  deleteEmployerBtn: { zh: "删除这份打工副本", en: "Delete this gig" },
  deleteEmployerConfirmBtn: { zh: "再点一次，确认永久删除", en: "Tap again to confirm deletion" },
  deletingEllipsis: { zh: "删除中...", en: "Deleting..." },
